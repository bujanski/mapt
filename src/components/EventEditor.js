...
import { fishSpeciesOptions } from '../store/MaptContext';
    ...
    <div id='event-editor'>
      <div className='editor-title'>
        ...
        <div className='event-stat-box'>
            ...
            onChange={(e) => setEventData({ ...eventData, fish_species: e.target.value })}
          >
        ...
        <div className='date-editor'>
          <div className='event-date'>                
                {eventData.weather.time}
            </div>
            <div id='date-picker'>
                Change date/time: <input type='text' id='datePickerInput' placeholder='Select date/time' />
            </div>
          </div>
        <div className='editor-field-title'>
            weather
        ...
        <div className='editor-button-container'>
          <p><input className="cancel-button" type='button' value="Cancel" onClick={handleCancel} ></input></p>
          <p><input className="submit-button" type='button' value="Update" onClick={handleSubmit} ></input></p>
